/*
 * @Author: xuxueliang
 * @Date: 2019-08-15 19:01:49
 * @LastEditors: xuxueliang
 * @LastEditTime: 2019-08-15 19:02:48
 */
/*!
 * Yam.js v0.2.0
 * (c) 2014-2019 xuxueliang
 * Released under the MIT License.
 * lastTime:Thu Aug 15 2019 18:57:39 GMT+0800 (GMT+08:00).
 */
/*eslint-disable*/
...
(function (global, factory) {
   ...
   * @LastEditors: xuxueliang
   * @LastEditTime: 2019-08-13 14:45:34
   */
  var global = window || {
  ...
  /*
   * @Author: xuxueliang
   * @Date: 2019-08-13 19:14:25
   * @LastEditors: xuxueliang
   * @LastEditTime: 2019-08-15 18:46:44
   */
  ...
  function getStyleStr (_id, style) {
    ...
    var isScope = styleIsScope(style[0]); // console.log(style)
          ...
          if (_typeof(styles) === 'object') {
            Object.keys(styles).forEach(function (prop) {
              ...
              if (typeof value === 'number') {
                ...
                throw new Error("Expected \"number\" or \"string\" but received \"".concat(_typeof(value), "\""));
              }
            });
          } else {
  ...
  */
  ...
  var ChildComponentsManage =
    ...
    function () {
      function ChildComponentsManage (context) {
        _classCallCheck(this, ChildComponentsManage);

        this.id = 'childComponents' + '-' + (context._eid || guid2());
        cacheLib.set(this.id, {});
      }

      _createClass(ChildComponentsManage, [{
        key: "get",
  ...
  function create () {
    ...
    Object.keys(data).forEach(function (key) {
      ...
      if (_typeof(_this2[$componentDataSymbol][key]) === 'object' && !Array.isArray(_this2[$componentDataSymbol][key]));
    });
  }
  ...
  function getCustom (Target) {
    ...
    var ElmApp =
      ...
      function (_HTMLElement) {
        _inherits(ElmApp, _HTMLElement);

        function ElmApp () {
          _classCallCheck(this, ElmApp);

          return _possibleConstructorReturn(this, _getPrototypeOf(ElmApp).apply(this, arguments));
        }
   ...
   * @Date: 2019-08-13 19:14:25
   * @LastEditors: xuxueliang
   * @LastEditTime: 2019-08-15 18:49:02
   */
